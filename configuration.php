...
$configArray["gatewayUrl"] = getenv("GATEWAY_URL");

// Merchant ID supplied by your payments provider
$configArray["merchantId"] = getenv('GATEWAY_MERCHANT_ID');

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "merchant.".getenv('GATEWAY_MERCHANT_ID');

// API password which can be configured in Merchant Administration
$configArray["password"] = getenv('GATEWAY_API_PASSWORD');
...
$configArray["debug"] = getenv('DEBUG');
...
$configArray["version"] = getenv('GATEWAY_API_VERSION');
