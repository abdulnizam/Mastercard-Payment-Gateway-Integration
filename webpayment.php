...
<html>
    ...
    <head>
        <title>API Payment Code</title>
        <meta http-equiv="Content-Type" content="text/html, charset=iso-8859-1">
    </head>

    <body>

        <h1>PHP Tester - REST (JSON)</h1>
        <h3>Simple Pay Operation</h3>
        <p><a href="index.php">Return to the Home Page</a></p>
        <p><a href="https://ap-gateway.mastercard.com/api/documentation/integrationGuidelines/supportedFeatures/testAndGoLive.html?locale=en_US" target="_blank">Sample Card Details</a></p>
        ...
        <table width="60%" align="center" cellpadding="5" border="0">
            ...
            <tr>
             ...
             <tr class="shade">
                 ...
                 <td width="50%"><input type="text" readonly="readonly" name="version" value="43" size="8" maxlength="80" /></td>
             </tr>
             ...
             <tr>
                 ...
                 <?php
                    ...
                    echo '<td><input type="text" name="orderId" value='. rand(111111,9999999) .' size="20" maxlength="60"/></td>';
                 ?>
             ...
             <tr class="shade">
                ...
                <?php
                    ...
                    echo '<td><input type="text" name="transactionId" value='. rand(1111111,99999999) .' size="20" maxlength="60"/></td>';
                 ?>
            ...
            <tr>
             ...
             <tr class="shade">
                 ...
                 <td><input type="text" name="order[amount]" value="1" size="8" readonly="readonly"  maxlength="13"/></td>
             </tr>

             <tr>
                 <td align="right"><strong>order.currency </strong></td>
                 <td><input type="text" name="order[currency]" value="AED" readonly="readonly"  size="8" maxlength="3"/></td>
             </tr>
